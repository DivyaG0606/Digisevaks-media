...
const PizzaMood = () => {
  ...
  const articleSchema = {
    ...
    "@type": "Article",
    "headline": "Pizza Mood — Building a Digital Franchise Growth Engine",
    "author": {
      "@type": "Organization",
    ...
    "about": "Franchise digital marketing and lead generation strategy for a growing pizza franchise brand",
    "articleSection": "Case Study",
    "url": "https://digisevaks.com/case-studies/pizza-mood",
    "keywords": "franchise marketing case study Pune, pizza franchise digital marketing, franchise lead generation agency Pune"
  };
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Pizza Mood", "item": "https://digisevaks.com/case-studies/pizza-mood" }
    ]
  };
  ...
  return (
    <div className="min-h-screen pt-64 pb-20 bg-[#F2EFE7]">
      <SEO 
        ...
        keywords="franchise marketing case study Pune, pizza franchise digital marketing, franchise lead generation agency Pune"
        canonical="https://digisevaks.com/case-studies/pizza-mood"
        ogTitle="Pizza Mood Case Study | Franchise Marketing Agency Pune | DigiSevaks"
        ogDescription="See how DigiSevaks Media helped Pizza Mood build a franchise lead generation engine through website development, SEO, and digital marketing."
        twitterTitle="Pizza Mood Case Study | Franchise Marketing Agency Pune | DigiSevaks"
        twitterDescription="See how DigiSevaks Media helped Pizza Mood build a franchise lead generation engine through website development, SEO, and digital marketing."
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 font-heading leading-tight">
            Pizza Mood — Building a Digital Franchise Growth Engine
          </h1>
          
          <p className="text-xl text-gray-600 max-w-3xl mx-auto font-body">
            Digital Transformation & Franchise Lead Generation for a Pizza Franchise Brand in Pune
          </p>
        ...
        >
          <div className="bg-white rounded-3xl p-8 md:p-12 border border-gray-200 shadow-sm">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-4 font-body">
              Pizza Mood is a growing food brand with ambitions to expand its presence through franchising. To support this growth, the brand needed a stronger digital ecosystem capable of presenting its franchise opportunity professionally, increasing online visibility, and converting interested prospects into franchise enquiries.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed font-body">
              DigiSevaks Media partnered with Pizza Mood to build a <span className="font-semibold text-primary">conversion-focused digital presence designed around franchise acquisition and brand growth.</span> The objective was not simply to create an attractive online presence—it was to create a digital platform that could actively contribute to franchise lead generation for pizza franchise digital marketing in Pune.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-6 font-body">
            Pizza Mood had an opportunity to expand through franchising, but needed a stronger digital foundation to support that growth. The key challenges included:
          </p>
          <ul className="space-y-3 text-lg text-gray-700 font-body">
            ...
            <li className="flex items-start">
              <span className="text-primary mr-3">•</span>
              Difficulty communicating the franchise proposition effectively
            </li>
            <li className="flex items-start">
              <span className="text-primary mr-3">•</span>
          ...
          <div className="mt-6 p-6 bg-white rounded-2xl border-l-4 border-primary shadow-sm">
            <p className="text-lg text-gray-800 font-body font-semibold">
              The business needed a strategy that connected brand awareness with measurable business intent.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="bg-gradient-to-r from-primary to-primary-dark rounded-3xl p-8 md:p-12 text-white mb-8 shadow-md">
            <p className="text-2xl font-bold mb-4 font-heading">
              Generate more qualified franchise enquiries while strengthening Pizza Mood's digital brand presence as a premier franchise marketing case study Pune.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              { title: "Build Franchise Credibility", desc: "Present Pizza Mood as a structured and attractive franchise opportunity." },
        ...
        >
          ...
          <p className="text-lg text-gray-700 leading-relaxed mb-8 font-body">
            DigiSevaks Media developed an integrated digital strategy combining technology, search visibility, branding, content, and lead generation.
          </p>
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-4 font-body">
                To improve Pizza Mood's digital discoverability, we implemented an SEO-focused approach:
              </p>
              <ul className="space-y-2 text-gray-700 font-body">
            ...
            >
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-4 font-body">
                A consistent visual identity was essential for establishing trust. We supported Pizza Mood with strategic branding and social media communication:
              </p>
              <ul className="space-y-2 text-gray-700 font-body">
        ...
        >
          ...
          <div className="bg-white rounded-2xl p-6 border-l-4 border-primary shadow-sm">
            <p className="text-lg text-gray-800 font-body">
              <span className="font-bold">Primary business outcome:</span> Increased franchise lead generation and a stronger digital foundation for Pizza Mood's expansion.
            </p>
          </div>
        </motion.div>
